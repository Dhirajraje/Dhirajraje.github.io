<div class="container">
	...
	<div class="flex flex-col md:grid grid-cols-9 mx-auto p-8 text-indigo-50 justify-center">
		<div class="flex flex-row-reverse md:contents">
			<div class="col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md border-2">
				...
				<h5 class="text-indigo-800 font-semibold text-sm">
					HTS Tech Solutions, Pune <span class="text-orange-500">Sept-2021:Current</span>
				</h5>
				<div class="my-3 flex flex-wrap -m-1">
					...
					>
					<span
						class="m-1 bg-blue-400 hover:bg-gray-300 rounded-full px-2 font-bold text-sm leading-loose cursor-pointer"
						>#React</span
					>
					<span
		...
		<div class="flex md:contents">
			...
			<div class="col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md border-2">
				...
				<p class="text-slate-600 leading-tight text-justify">
					● Migrated OnPrem IoT infrastructure to AWS cloud.<br />● Led implementation KPIs, Events, monitoring and billing reporting for IoTand AWS services.
				</p>
			</div>
		</div>
		<div class="flex flex-row-reverse md:contents">
		...
		<div class="flex md:contents">
			...
			<div class="col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md border-2">
				...
				<h5 class="text-indigo-800 font-semibold text-sm">
					Savitribai phule pune university, Pune <span class="text-orange-500">Jun-2017:Jun-2021</span>
				</h5>
				<div class="my-3 flex flex-wrap -m-1">
					<span
						class="m-1 bg-orange-400 hover:bg-gray-300 rounded-full px-2 font-bold text-sm leading-loose cursor-pointer"
