<section class="text-slate-600 body-font" id="#top">
	<div class="container mx-auto flex px-5 py-4 md:flex-row flex-col items-center">
		<div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
			<img class="object-cover object-center rounded" alt="hero" src="/developer.gif" />
		</div>
		<div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col items-start text-left ">
			<h1 class="title-font font-bold sm:text-4xl text-3xl mb-4 text-slate-700">Dhiraj Salunke</h1>
			<h2 class="title-font font-bold sm:text-4xl text-3xl mb-4 ">
				<span class="text-orange-500">def</span>
				<span class="text-indigo-900">skills(<span class="text-blue-500">self</span>):</span>
			</h2>
			<p class="mb-4 leading-relaxed">
				I am a <span class="text-indigo-900 font-semibold"
					>full stack developer, AWS cloud engineer</span
				>. I have been working as full stack developer and building softwares since
				...
				<span class="text-indigo-900 font-semibold"
					>FastAPI, ExpressJS, Flutter, Svelte, ReactJS</span
				> and more...
			</p>
